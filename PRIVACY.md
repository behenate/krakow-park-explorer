...
- **On-device storage.** Your check-ins, notes, photos and settings live only
...
- **Network use.** The app downloads map tiles (OpenFreeMap) and computes
  routes online; these requests are not tied to your identity by us.

This is an unofficial app, not affiliated with Zarząd Zieleni Miejskiej
w Krakowie. Questions: open an issue at
